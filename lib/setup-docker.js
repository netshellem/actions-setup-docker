...
`]);
  ...
  // } else {
    ...
    await shell(`
    curl -fsSL https://mirror.azure.cn/docker-ce/linux/ubuntu/gpg | gpg --dearmor | sudo sh -c 'cat >/usr/share/keyrings/docker-archive-keyring.gpg'
    `);
    ...
    await shell(`
    echo \
      "deb [arch=amd64,arm64 signed-by=/usr/share/keyrings/docker-archive-keyring.gpg] https://mirror.azure.cn/docker-ce/linux/ubuntu \
